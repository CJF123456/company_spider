...
public class QinghaiQyxySpider {

	private static String listurl = "http://218.95.241.36/exceptionInfoSelect.jspx";
	private static Log logger = LogFactory.getLog(QinghaiQyxySpider.class);
	...
	static {
		// 启动日志
		try {
			PropertyConfigurator.configure(QinghaiQyxySpider.class
