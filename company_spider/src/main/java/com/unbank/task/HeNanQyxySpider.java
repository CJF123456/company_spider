...
public class HeNanQyxySpider {

	private static String listurl = "http://222.143.24.157:80/exceptionInfoSelect.jspx";
	private static Log logger = LogFactory.getLog(HeNanQyxySpider.class);
	...
	private static String tablePre = "henan";

	static {
		// 启动日志
		try {
			PropertyConfigurator.configure(HeNanQyxySpider.class
