...
/***
 * 海南
 * @ClassName: HainanQyxySpider
 * @Description: TODO
 * @author Administrator
 * @date 2016-8-31 上午9:40:37
 */
public class HainanQyxySpider {

	private static String listurl = "http://aic.hainan.gov.cn:1888/exceptionInfoSelect.jspx";
	private static Log logger = LogFactory.getLog(HainanQyxySpider.class);
	...
	private static String tablePre = "hainan";

	static {
		// 启动日志
		try {
			PropertyConfigurator.configure(HainanQyxySpider.class
