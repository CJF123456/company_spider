 ...
 * @result 已完结
 */
public class XizangQyxySpider {

	private static String listurl = "http://gsxt.xzaic.gov.cn/exceptionInfoSelect.jspx";
	private static Log logger = LogFactory.getLog(XizangQyxySpider.class);
	...
	private static String tablePre = "xizang";

	static {
		// 启动日志
		try {
			PropertyConfigurator.configure(XizangQyxySpider.class
