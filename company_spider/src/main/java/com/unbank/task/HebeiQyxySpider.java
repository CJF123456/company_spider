...
public class HebeiQyxySpider {
	private static String listurl = "http://www.hebscztxyxx.gov.cn/notice/search/ent_except_list";
	...
	private static String tablePre = "hebei";
