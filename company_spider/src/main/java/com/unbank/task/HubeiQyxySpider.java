...
public class HubeiQyxySpider {

	private static String listurl = "http://xyjg.egs.gov.cn/ECPS_HB/exceptionInfoSelect.jspx";
	private static Log logger = LogFactory.getLog(HubeiQyxySpider.class);
	...
	private static String tablePre = "hb";

	static {
		// 启动日志
		try {
			PropertyConfigurator.configure(HubeiQyxySpider.class
