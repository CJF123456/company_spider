...
public class FJQyxySpider {
	private static String listurl = "http://wsgs.fjaic.gov.cn/creditpub/search/ent_except_list";
	private static Log logger = LogFactory.getLog(FJQyxySpider.class);
	...
	private static String tablePre = "fj";

	static {
		// 启动日志
		try {
			PropertyConfigurator.configure(FJQyxySpider.class
